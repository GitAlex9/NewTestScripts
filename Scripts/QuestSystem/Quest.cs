...
public class Quest
{
    ...
    public string GetFullStatusText()
    {
        ...
        {
            fullStatus = "Os requisitos para iniciar esta missão ainda não foram atendidos.";
        }
        else if (state == QuestState.CAN_START)
        {
            fullStatus = "Esta missão pode ser iniciada!";
        }
        else 
        {
            ...
            {
                fullStatus += "A missão está pronta para ser entregue!";
            }
            else if (state == QuestState.FINISHED)
            {
                fullStatus += "A missão foi concluída!";
            }
        }
        return fullStatus;
    }
